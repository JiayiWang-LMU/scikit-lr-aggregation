...
class BaseDecisionTree(BaseEstimator, metaclass=ABCMeta):
    ...
    def fit(self, X, Y, sample_weight=None):
        ...
        rank_algorithm = self.rank_algorithm.pop("rank_algorithm")
        self._rank_algorithm = RankAggregationAlgorithm.get_algorithm(rank_algorithm, **self.rank_algorithm)
...
class DecisionTreeLabelRanker(LabelRankerMixin, BaseDecisionTree):
    ...
    def __init__(self,
        ...
        super().__init__(rank_algorithm="borda_count",
                         criterion=criterion,
                         distance=distance,
                         splitter=splitter,
                         max_depth=max_depth,
