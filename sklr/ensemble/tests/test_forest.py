"""Testing for the forest_models module."""
...
# A toy example to check that the forest_models rankers
...
def test_toy_example(RandomForestRanker, criterion, splitter, distance):
    """Test the forest_models rankers on a toy dataset."""
    # Initialize the forest_models ranker using the given
    ...
    # used to fit the different forest_models rankers
    sample_weight = random_state.randint(10, size=(X_train.shape[0]))

    # Fit the forest_models ranker to the training
