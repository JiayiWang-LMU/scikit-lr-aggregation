...
class BaseForest(BaseEnsemble, ABC):
    ...
    def __init__(self,
        ...
        super().__init__(rank_algorithm=rank_algorithm,
    ...
    def fit(self, X, Y, sample_weight=None):
        ...
        self._rank_algorithm = RankAggregationAlgorithm.get_algorithm(self.rank_algorithm)
...
class RandomForestLabelRanker(ForestLabelRanker):
    ...
    def __init__(self,
        ...
        """Constructor."""
        # Call to the constructor of the parent
        super().__init__(rank_algorithm,
                         base_estimator=DecisionTreeLabelRanker(),
                         n_estimators=n_estimators,
...
class RandomForestPartialLabelRanker(ForestPartialLabelRanker):
    ...
    def __init__(self,
        ...
        # Call to the constructor of the parent
        super().__init__(rank_algorithm=rank_algorithm,
                         base_estimator=DecisionTreePartialLabelRanker(),
                         n_estimators=n_estimators,
                         estimator_hyperparams=(
                             "rank_algorithm",
                             "criterion",
