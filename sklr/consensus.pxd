...
from ._highs_solver cimport HighsSolver
...
cdef class RankAggregationAlgorithm:
    ...
    # Markov chain
    cdef DTYPE_t_1D eigen_values_real
    cdef DTYPE_t_1D eigen_values_imag
    cdef DTYPE_t_2D eigen_vectors_right

    cdef DTYPE_t_1D work

    cdef DTYPE_t_1D target_eigenvector
    cdef DTYPE_t_1D stationary_distribution

    # Maximum lottery
    cdef HighsSolver solver
    cdef double[:, :] A
    cdef DTYPE_t_1D x
